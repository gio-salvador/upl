...
| `scripts/` | `check.sh`, the single gate entry point that CI also runs, the gates it calls (doctrine, cross-reference, infrastructure posture), and `visual-changed.sh`, which decides whether the rendering gate is needed. |
