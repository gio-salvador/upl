...
The author's decisions on questions the text left open, and the wording proposed to carry each
one into the teachings. For the author, and for anyone or any agent drafting a teaching
afterwards, so that a decision taken once is not asked again or contradicted.

This page is not a teaching. Where it and a page under `content/` disagree, the page under
`content/` is right and this page needs fixing. A decision here changes no page by itself: each
...
Similar to seichonoie teachings."

The points settled with it:

1. **Source beyond.** God is the source; the universe and we are light flowing from it. The
   source is more than what it emits. UPL stands close to pantheism and is not the same as it.
2. **Love stays; will is reworded.** "God's love" is kept and explained once as the nature of
   the light itself, not the feeling of a person. "Divine will" is reworded towards "divine
   order", since a principle has no will.
3. **Prayer is attunement.** Prayer aligns the person with the light: affirmation, gratitude,
   stillness, listening inwardly. Where a borrowed prayer addresses God as a person, those words
   are read as poetry.
...
6. **"Child of God" is credited, not adopted.** It is named as Seicho-No-Ie's phrase when that
...
**P1. Holistic Well-being, section introduction. Wording change. Not locked.**

- Before: "Central to its philosophy is the promotion of sobriety, a cautious engagement with
  science and modern medicine, and a clear stance against the use of recreational and illegal
  drugs."
- After: "Central to its philosophy is the promotion of sobriety, trust in science and modern
  medicine, and a clear stance against the use of recreational and illegal drugs."
- Why: "cautious" contradicts the title of the page beneath it and D2.

**P2. Trust in Science and Modern Medicine, "Balanced Approach to Health". Wording change. Not
locked.**
...
**P3. Comparative Analysis, the paragraph on Hinduism and Buddhism. Wording change. Not
locked.**

- Before: "Similar to Hinduism and Buddhism, UPL posits karma and dharma as guiding principles
  of spiritual evolution, but it refrains from concepts like the caste system or affirming
  suffering as an inherent characteristic of life."
- After: "Similar to Hinduism and Buddhism, UPL posits karma and dharma as guiding principles of
  spiritual evolution. It does not take up the caste system. With Buddhism it shares the path of
  mindfulness, ethical conduct and compassion, and it honours the Buddha's teaching that
  suffering can be understood and brought to an end. It parts from Buddhism on the self:
  Buddhism teaches that there is no permanent self, while UPL holds, as Hinduism does, that the
  soul is real and immortal."
- Why: D3. It also removes the contradiction with the page on the Buddha.

### For D1

**P4. Comparative Analysis, the paragraph on the monotheistic religions. Wording change. Not
locked.**

- Before: "Compared to monotheistic religions like Christianity, Islam, and Judaism, UPL doesn't
  focus on a singular personal deity. Rather than the emphasis on obedience to God's will
  prevalent in these religions, UPL promotes an understanding of divine principles and their
  manifestation within oneself and the universe."
- After: "Compared to monotheistic religions like Christianity, Islam, and Judaism, UPL does not
  understand God as a person. God is the one source of light, and all that exists is light from
  that source. Where these religions speak of obedience to God's will, UPL speaks of
  understanding divine principles and living in harmony with the light within oneself and the
  universe."
- Why: D1. "Doesn't focus on" left open whether such a deity exists; the new text says what UPL
  holds.

**P5. Comparative Analysis, the paragraph on pantheism. Wording change. Not locked.**

- Before: "UPL aligns with contemporary movements such as pantheism in viewing the divine as an
  integral part of the universe and possibly beyond, but it extends this view to incorporate
  ethical living and continual learning, distinguishing it from a mere philosophical stance."
- After: "UPL stands close to pantheism in viewing the divine as present in all of the universe.
  It differs in holding that God is also the source beyond the universe, from which the universe
  flows as light, and in joining this view to ethical living and continual learning, which
  distinguishes it from a mere philosophical stance."
- Why: D1, point 1. "Possibly beyond" is now decided.

**P6. God, Quantum Physics, and the Light of Divinity. Addition, after the paragraph that begins
...
- After: "Darkness has no source of its own. It is where the light is obscured, by ignorance, by
  fear or by harmful action. Suffering and illness are real, and they call for real help.
  Ethical living, mindful action and the working of karma and dharma are how what obscures the
  light is cleared."
- Why: D1, point 5. This is a new concept, "darkness", and the God page becomes its owner in
  the cross-reference matrix.

**P8. The Spiritual Dimension of Environmental Stewardship. Wording change. Not locked.**

- Before: "they are engaging in a sacred act of healing themselves and aligning with the divine
  will."
- After: "they are engaging in a sacred act of healing themselves and aligning with the divine
  order."
- Why: D1, point 2.

**P9. Adopting Prayers from Various Traditions. Wording change. Not locked.**

- Before: "UPL encourages the use of prayers from different religions as a form of spiritual
  dialogue, offering a means of affirming core beliefs, expressing gratitude, seeking guidance,
  and fostering a profound sense of connection with the divine."
- After: "UPL encourages the use of prayers from different religions as a form of attunement to
  the divine light, offering a means of affirming core beliefs, expressing gratitude, listening
  inwardly for guidance, and fostering a profound sense of connection with the divine. Where a
...
"sovereignty" would misdescribe Tawhid (balance rule 4: a tradition's own terms, used
correctly). The page does lean on Islam alone. That is the known imbalance, and it is better
answered when the ten core beliefs are given voices from several traditions than by a change
made for D1.
...
- Prayers that address God (the Lord's Prayer, Al-Fatiha, "lead me from darkness to light") can
  be given as examples, read under D1 point 3.
- Seicho-No-Ie's teaching on healing is adopted only as a complement to medicine (D2), and its
...
Asked for by the author. Each line is a claim a proposal rests on, what was found, and the sources by their ids in the
[source register](sources.md), which holds the links.

| Claim | Used in | Result |
| --- | --- | --- |
| In Judaism, saving a life comes before almost every other duty | P2 | Confirmed. The principle is pikuach nefesh. It overrides nearly every commandment, the Sabbath included; the three exceptions are murder, idolatry and forbidden sexual relations, so "almost" is right. S03, S04 |
| Seicho-No-Ie teaches that the person is a child of God and already perfect; "true image" is its term | P6, P11 | Confirmed. The movement states: "Man is in reality a child of God. Man is not matter but spiritual existence. Man is already a perfect being." The True Image (jissō) is the God-created perfect world, the only one that truly exists. The P6 sentence was reworded to follow this. S05, S06 |
| The silkworm and cocoon image comes from Seicho-No-Ie | The soul section; new P13 | Confirmed, and closer than expected. The Nectarean Shower of Holy Doctrines says that spiritual life "weaves its threads of mind to build a cocoon of flesh", that "the physical body is not man but merely man's cocoon", and that man will "break out of his body-cocoon and ascend to the spiritual world". The Immortal Soul uses the same image, the same "thread of their minds" and the same "body cocoon", without credit. S07, S08 |
| The Chandogya Upanishad says of the self and the ultimate reality, "you are that" | P6 | Confirmed. "Tat tvam asi" is repeated through chapter 6, where Uddalaka Aruni teaches his son. Reading it as full identity is the Advaita school's; other schools read it as a close relation. The P6 wording does not take a side. S09 |
| Belief and expectation bring real relief through the body's own means | P2 | Confirmed for pain. Naloxone, which blocks opioids, reverses placebo pain relief, so the relief is the body's own opioids at work (Levine, Gordon and Fields, 1978). S10, S11 |
| Science has yet to show that belief alone can cure a disease | P2 | Confirmed. The largest review of placebo against no treatment "did not find that placebo interventions have important clinical effects in general"; effects were on what patients report, above all pain, and not on the disease. In an asthma trial, patients on a placebo inhaler reported as much improvement as those on the drug, while measured lung function rose about 20 per cent on the drug and about 7 per cent on placebo, the same as with no treatment at all. S12, S13 |
