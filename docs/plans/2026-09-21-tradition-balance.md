...
**Status: in progress.** Steps 1 to 3 are done: the sources, the convergence map, and the first
four core beliefs. Requested 2026-09-21. The author took decisions B1 to
